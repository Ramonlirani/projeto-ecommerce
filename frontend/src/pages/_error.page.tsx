  ...
  return (
    <div className="w-full flex min-h-screen items-center justify-center relative flex-col gap-6">
      ...
      <Link href="/" className="mt-4">
        <div className="flex gap-3 items-center text-off-red">
      ...
      >
        <div
          className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-off-red to-off-red opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
